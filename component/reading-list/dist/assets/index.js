        ...
        <tbody>
          ${this.filteredBooks.map(s=>{var e;return d`
              <tr>
                ...
                <td class="notes-cell">
                  ${(e=s.notes)!=null&&e.trim()?s.notes.trim():d`<span class="not-applicable">—</span>`}
                </td>
              </tr>
            `})}
        </tbody>
